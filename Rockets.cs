...
namespace WindowsFormsApp_7
{
    ...
    {
        Submarine_radar _radar;
        Military_Acts _military;
        Random random = new Random();
        public Rockets(Submarine_radar radar, Military_Acts military)
        {
            InitializeComponent();
            _radar = radar;
            _military = military;
        ...
        private void boom_btn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                switch (s)
                {
                    ...
                    default:
                        {
                            _military.rocket_type = rocket_cmbx.SelectedItem.ToString();
                            _military.Rocket_Attack();
                            _radar.enemy_flag = false;
                            break;
                        }
                }   
            }
